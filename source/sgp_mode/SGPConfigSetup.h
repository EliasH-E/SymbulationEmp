...
enum ParentTaskType {CURRENTONLY = 0, PARENTONLY = 1, CURRENTORPARENT = 2}
enum PreferentialOustType {OFF = 0, EQUIVALENT = 1, BETTER = 2}
...
EMP_EXTEND_CONFIG(SymConfigSGP, SymConfigBase,
  ...
  VALUE(SYMBIONTS_ESCAPE, bool, 0, "Do symbionts get the chance to escape their host if it dies during an extinction event? (0 for no, 1 for yes)"),
